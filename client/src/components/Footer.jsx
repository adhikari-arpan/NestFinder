...
export const Footer = () => {
  ...
  return (
    <footer className="bg-[var(--bg-card)] border-t border-[var(--border-color)] pt-24 pb-14 mt-auto transition-[background] duration-[var(--transition-normal)]">
      <div className="container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-14 mb-20">
          ...
          <div className="flex flex-col gap-5 text-left">
            ...
            <p className="text-[0.9rem] text-[var(--text-muted)] leading-[1.8]">
          ...
          <div className="flex flex-col gap-6 text-left">
            ...
            <div className="flex flex-col gap-5 text-[0.85rem] text-[var(--text-muted)]">
              <div className="flex items-start gap-3">
                <MapPin size={16} className="text-[var(--primary)] shrink-0 mt-0.5" />
                <span className="leading-[1.7]">Balkumari, Lalitpur, Nepal</span>
              </div>
              <div className="flex items-start gap-3">
                <Phone size={16} className="text-[var(--primary)] shrink-0 mt-0.5" />
                <span className="leading-[1.7]">+977-1xxxxxxxxx, +977-98xxxxxxxx</span>
              </div>
              <div className="flex items-start gap-3">
                <Mail size={16} className="text-[var(--primary)] shrink-0 mt-0.5" />
                <span className="leading-[1.7]">@nestfinder.com.np</span>
              </div>
            </div>
          </div>
        ...
        {/* Bottom copyright */}
        <div className="pt-8 pb-2 flex justify-between items-center flex-wrap gap-4 text-[0.85rem] text-[var(--text-light)]">
