...
export const ResultCard = ({ item, reasons }) => {
  return (
    <div className="card overflow-hidden rounded-[var(--radius-lg)] bg-[var(--bg-card)] p-0 shadow-lg transition-all duration-300 hover:border-(--primary) hover:shadow-xl">
